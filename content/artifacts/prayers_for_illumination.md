...
# category: artifacts
# icon: assets/icons/artifacts/prayers_for_illumination.webp
# title_ru: Шаман огня
...
Вечные льды ещё только начинали таять, и загорались первые костры.
...
Вопрос этот посланники богов оставили без ответа.
Тогда люди избрали верховного жреца, короновали его венцом из белых ветвей и отправили в глубины мираискать среди покоящихся под землёй древних алтарей ответа...

## EN
### Circlet of Logos
**Название:** Tiara of Flame
