...
# category: artifacts
# icon: assets/icons/artifacts/prayers_for_wisdom.webp
...
## RU
### Корона разума
**Название:** Тиара грома

**Описание:** Говорят, чтокогда-то люди получали озарения прямиком от самих небес.
В те времена посланники богов ходили меж тёмных смертных.
...
Ведь сомневаться в вечном было запрещено, а земле бросать небесам вызов - непростительно.
Поэтому увенчанный белыми ветвями верховный жрец решил задобрить божественных посланников, и отправился в глубины мира за тайной мудростью, которая покоилась на ветвях серебряного древа.

## EN
### Circlet of Logos
**Название:** Tiara of Thunder
