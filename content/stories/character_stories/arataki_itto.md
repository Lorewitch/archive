...
# title_ru: Итто
# title_en: Arataki Itto
# title_zh: 荒泷一斗
# region: Инадзума
# element: geo
# rarity: 5
# game_version: 2.3
# icon: assets/icons/stories/character/arataki_itto.webp
# tags:
# character_filters:
...
Unfortunately for Itto, his allergies are pretty still pretty severe. Forget eating beans, so long as he makes skin contact with them, Itto will get itchy all over and even find it hard to breathe.
...
Of all products made with beans, Itto fears Fried Tofu the most — indeed, even he says that the very sight of it leaves him feeling queasy for three days straight.
