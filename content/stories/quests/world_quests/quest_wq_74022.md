...
# chapter_num_en:
# chapter_num_zh:
# part_source_ids: 74022
# previous_quests:
# next_quests: quest_wq_74023
# related_quests: quest_wq_74015,quest_wq_74019,quest_wq_74020,quest_wq_74021,quest_wq_74023
...
**Сальса:** Большое здание выглядит по-настоящему грандиозно, если в нём соблюдена симметрия!

**Сальса:** Симметрия всегда радует глаз...

**Сальса:** У асимметрии есть свои достоинства, но здесь явно не хватает симметрии. Когда с одной стороны один столб, а с другой - три, получается дисбаланс.
...
**Salsa:** A large building would look much more magnificent if it has a symmetrical design!

**Salsa:** Symmetrical designs are just so satisfying to look at!

**Salsa:** Asymmetry also has its merits, but symmetry would look better here. One on one side and three on the other make it look way too unbalanced.
...
**萨莎:** 大型的建筑物如果是对称设计看起来就很有宏伟的感觉呢！

**萨莎:** 对称设计真让人心情舒畅…

**萨莎:** 不对称也有不对称的好，不过这里还是对称比较好看呢。一边一个，一边三个，太不平衡了。
