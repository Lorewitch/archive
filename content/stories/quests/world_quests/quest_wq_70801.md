...
# chapter_num_en:
# chapter_num_zh:
# part_source_ids: 70801
# previous_quests:
# next_quests:
# related_quests:
# quest_chain: quest_wq_70801
# quest_series:
...
Свен всё делает по учебнику, точнее, по руководству для рыцарей Ордо Фавониус. У него не было вопросов к путешественни(це)(ку), пока т(а)(от) не стал(а) почётным рыцарем ордена. Теперь Свен просто обязан проверить вас на знание кодекса поведения рыцаря Ордо Фавониус.

#### Поговорите со Свеном

Я готов(а).

**Свен:** Славно. Тогда давайте начнём.

Ого, рыцари Ордо Фавониус такие строгие...

**Свен:** Всё верно. Как я и говорил, эти вопросы вас, почётный рыцарь, не могли затруднить.

**Свен:** Честно говоря, не все местные жители могут ответить верно на некоторые вопросы.

**Свен:** Ах да! Пожалуйста, примите этот подарок.

Ого, рыцари Ордо Фавониус такие строгие...

**Свен:** Хмм... К сожалению, не на все вопросы вы ответили верно.
...
**Свен:** Ничего страшного. Готовьтесь, сколько необходимо.
...
**Свен:** Руины древнего города на северо-западе Мондштадта. Некогда это была легендарная башня деспота и тирана, но в последнее время она стала убежищем для дракона ветра Двалина.
...
**Свен:** Но официально это место называется «логово Ужаса Бури».

## EN

### Question and Answer

Swan does everything by the book — specifically, by the Knights of Favonius Handbook. Previously, Swan wouldn't ask anything of the Traveler, who was not a Knight then. Now that the Traveler is an Honorary Knight, Swan will sometimes quiz the Traveler concerning the contents of the Handbook.
