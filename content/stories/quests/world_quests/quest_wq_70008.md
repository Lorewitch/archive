...
# chapter_num_en: 
# chapter_num_zh: 
# part_source_ids: 70008
# previous_quests: 
# next_quests: 
# related_quests: quest_eq_10021,quest_eq_10022,quest_eq_10023,quest_eq_10024,quest_wq_70000,quest_wq_70001,quest_wq_70003,quest_wq_70007,quest_wq_70009,quest_wq_70010,quest_wq_70654,quest_wq_70656,quest_wq_70657,quest_wq_70658,quest_wq_70800
...
- **Путешественник:** Я соберу семена одуванчика.

- **Путешественник:** Я соберу ветряные астры.
...
**Маргарита:** Я рассчитываю на тебя. В долине Ветров растут прекрасные ветряные астры. Пожалуйста, собери их там.
...
**Маргарита:** Путешественник, хочешь попробовать приготовить напиток сам(а)?

Хочу.

**Маргарита:** Отлично! Сначала я объясню процесс приготовления этого напитка, так что будь внимател(ьна)(ен).
...
**Маргарита:** Если ты всё запомнил(ла), можешь приступать. Спроси меня, если что-то забыла.

#### Приготовьте напиток

**Паймон:** Вроде всё запомнили. Ну что ж, за дело!

- **Путешественник:** Позволить настояться.

- **Путешественник:** Добавить лёд.

- **Путешественник:** Добавить молоко.

- **Путешественник:** Добавить ветряные астры.

- **Путешественник:** Добавить цветок-сахарок.

- **Путешественник:** Добавить семена одуванчика.

**Паймон:** Хм... А потом...

- **Путешественник:** Дать настояться
...
**Маргарита:** Эти семена одуванчика очень даже хороши. Какими они будут на вкус, когда я сделаю напиток?..
...
**Маргарита:** Осталось только дать другим попробовать этот напиток. Можно попросить тебя угостить кого-нибудь, Путешественник?
...
**Маргарита:** Ну как, ты нашла желающих попробовать напиток?
...
**Margaret:** However, they'll get drunk very quickly if all they drink is alcohol, and they'll be liable to get pulled aside by the Knights until they've sobered up...
...
**Margaret:** As such, I've decided to create a refreshing, non-alcoholic drink that's milk-based and filled with the flavor of the "wind."
...
- **Traveler:** I'll go get those Dandelions.

- **Traveler:** I'll get you those Windwheel Asters.
...
**Margaret:** I'll go collect some Dandelions Seeds for my part, and we'll meet back here once we're done collecting our respective ingredients.
...
**Margaret:** If you've memorized the steps, give it a go. If you've forgotten, feel free to ask me again.
...
- **Traveler:** Place ice cubes in.

- **Traveler:** Pour milk in.

- **Traveler:** Place Windwheel Aster in.

- **Traveler:** Place Sweet Flower in.

- **Traveler:** Place Dandelion Seeds in.
...
- **Traveler:** Scatter Dandelion Seeds
...
**Margaret:** These are some very fine Dandelions. I wonder what flavors we'll achieve if we use these in our blend...
...
**Margaret:** I'll be relying on you, then. I believe there'll be tons of people near the Anemo Archon statue. You can probably find some testers there.
...
**Aramis:** Oh? Well... then... I guess it'll be fine. I'm feeling a little thirsty, in any case, so I'll give it a go...

**Aramis:** Oh! This is pretty good. It's refreshing, too. Really perks you right up.

**Aramis:** This is a new product from The Cat's Tail, is it? I'll go have another taste later when I can spare the time.
...
**玛格丽特:** 首先放入甜甜花，再浇入调酒专用的基酒…当然，我们这次用的是牛奶，这就有了口感清甜的基底。

**玛格丽特:** 为了增添风味，这时候再加入风车菊。

**玛格丽特:** 然后别急着混合，得静置一会儿，让花的香味慢慢散发出来。

**玛格丽特:** 再撒入蒲公英籽，酒液里就会像散满星星一样好看，最后放入冰块就大功告成了。
