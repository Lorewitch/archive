...
# chapter_num_en: 
# chapter_num_zh: 
# part_source_ids: 73693
# previous_quests: 
# next_quests: 
# related_quests: quest_eq_10139,quest_eq_10140,quest_eq_10141,quest_wq_73520,quest_wq_73521,quest_wq_73522,quest_wq_73524,quest_wq_73690,quest_wq_73691,quest_wq_73692,quest_wq_73694,quest_wq_73695,quest_wq_73696
...
**Бахадор:** Эм?! Путешественни(ца)(к), хм... Да-да, здесь... как раз... проводится мероприятие.
...
**Бахадор:** Путешественни(ца)(к), если тебе интересно, возьми зелья и отправляйся на разведку в подземелье. Я отмечу его местоположение на твоей карте.

- **Путешественник:** Кто-то уже заинтересовался?

- **Путешественник:** Кто-то уже приходил играть, кроме меня?
...
- **Путешественник:** Тогда я отправлюсь в подземелье.
...
Does this Domain have anything to do with the Gala?
...
**Bahador:** So if you're interested, Traveler, take these potions with you and go investigate the Domain. I'll mark its location on your map.
...
- **Traveler:** In that case, I'll head in as well.

- **Traveler:** I've got other things to do at the moment.

**Bahador:** Really? Sure, then! in that case, please take these potions with you...

**Bahador:** You're going? Well, alright then. As for me, I've got to stick around here...
