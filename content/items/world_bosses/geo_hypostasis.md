...
Кодовое название: Гимель. Высококонцентрированный Гео элемент. Элементальный гипостазис - это сверхкомпактная структура с высокой массой. Высокая концентрация элементальной энергии образует твёрдую оболочку вокруг ядра, активно реагирующего на элементальные стимулы.
...
代号为「基末尔」 的高级岩元素生命。 无相元素本身是超浓缩的构造体，拥有极高的质量。 浓缩成硬质固体的元素超质壳是惰性的，只有内部的核会活跃发生元素反应。
