...
Кодовое название: Алеф. Высококонцентрированный Электро элемент. Элементальный гипостазис - это высшая форма элементальной структуры, которая формируется в местах с зашкаливающей элементальной энергией или с тяжёлой проходимостью элементов. Элементальный гипостазис разработал защитные механизмы, основанные на его элементе.
...
代号为「阿莱夫」 的高级雷元素生命。 无相元素是顶尖的元素构造体，会在元素能量喷涌的位置，或元素地脉阻塞的地点形成。 不同的无相元素会基于其元素特性，进化出战斗的方式。
