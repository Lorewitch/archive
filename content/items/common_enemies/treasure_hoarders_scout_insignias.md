# id: treasure_hoarders_scout_insignias
# category: items
# item_group: common_enemies
# game_version: 1.0
# entry_type: enemy_drops

# tags: Treasure Hoarder Insignia, Silver Raven Insignia, Golden Raven Insignia, обычные противники

# title_ru: Печать Похитителей сокровищ / Печать серебряного ворона / Печать золотого ворона
# title_en: Insignias
# title_zh: 寻宝鸦印 / 藏银鸦印 / 攫金鸦印
# region: Мондштадт, Ли Юэ, Инадзума, Сумеру, Фонтейн, Натлан, Нод-Край
# icon: assets/icons/items/common_enemies/treasure_hoarder_insignia.webp

# dropped_by: treasure_hoarders_scout, treasure_hoarders_pyro_potioneer, treasure_hoarders_hydro_potioneer, treasure_hoarders_electro_potioneer, treasure_hoarders_cryo_potioneer, treasure_hoarders_handyman, treasure_hoarders_marksman, treasure_hoarders_gravedigger, treasure_hoarders_seaman, treasure_hoarders_pugilist, treasure_hoarders_crusher

# material_1_id: treasure_hoarder_insignia
# material_1_ru: Печать Похитителей сокровищ
# material_1_en: Treasure Hoarder Insignia
# material_1_zh: 寻宝鸦印
# material_1_icon: assets/icons/items/common_enemies/treasure_hoarder_insignia.webp

# material_2_id: silver_raven_insignia
# material_2_ru: Печать серебряного ворона
# material_2_en: Silver Raven Insignia
# material_2_zh: 藏银鸦印
# material_2_icon: assets/icons/items/common_enemies/silver_raven_insignia.webp

# material_3_id: golden_raven_insignia
# material_3_ru: Печать золотого ворона
# material_3_en: Golden Raven Insignia
# material_3_zh: 攫金鸦印
# material_3_icon: assets/icons/items/common_enemies/golden_raven_insignia.webp
...
A signet that proudly represents its owner's position as member of the Treasure Hoarders. The pursuit of treasure knows no bounds. That said...
Is being a thief something to be proud of?

### material: silver_raven_insignia

A raven insignia used by members of the Treasure Hoarders to identify each other. The Treasure Hoarders ask for no resume.
