# id: eremite_axe_vanguard_reds
# category: items
# item_group: common_enemies
# game_version: 3.0
# entry_type: enemy_drops

# tags: Faded Red Satin, Trimmed Red Silk, Rich Red Brocade, обычные противники

# title_ru: Выцветший красный шёлк / Окаймлённый красный шёлк / Златотканый красный шёлк
# title_en: Reds
# title_zh: 褪色红绸 / 镶边红绸 / 织金红绸
# region: Сумеру
# icon: assets/icons/items/common_enemies/faded_red_satin.webp

# dropped_by: eremite_axe_vanguard, eremite_crossbow, eremite_ravenbeak_halberdier, eremite_linebreaker, eremite_sword_dancer, eremite_desert_clearwater, eremite_sunfrost, eremite_daythunder, eremite_galehunter, eremite_stone_enchanter, eremite_scorching_loremaster, eremite_floral_ring_dancer

# material_1_id: faded_red_satin
# material_1_ru: Выцветший красный шёлк
# material_1_en: Faded Red Satin
# material_1_zh: 褪色红绸
# material_1_icon: assets/icons/items/common_enemies/faded_red_satin.webp

# material_2_id: trimmed_red_silk
# material_2_ru: Окаймлённый красный шёлк
# material_2_en: Trimmed Red Silk
# material_2_zh: 镶边红绸
# material_2_icon: assets/icons/items/common_enemies/trimmed_red_silk.webp

# material_3_id: rich_red_brocade
# material_3_ru: Златотканый красный шёлк
# material_3_en: Rich Red Brocade
# material_3_zh: 织金红绸
# material_3_icon: assets/icons/items/common_enemies/rich_red_brocade.webp
...
Красная шёлковая лента, обшитая по краям простой каймой. Опытный воин способен по взгляду противника нащупать его слабину.
Пустынники давно утратили своих покровителей и могут полагаться только на себя. Они ничему не доверяют – даже собственному взгляду.
...
A piece of red silk trimmed with simple decorations. A seasoned warrior can detect weaknesses from their foe's eyes and thus take advantage.
The Eremites have long since lost a master to serve, and now they have no one to trust but themselves.
...
用以遮盖眼睛的红色绸缎，略有残破。镀金旅团当中常有人以织物遮蔽双眼，而这种举动的肇始早已失落在时之沙海中。
