# id: primal_construct_repulsor_prisms
# category: items
# item_group: common_enemies
# game_version: 3.1
# entry_type: enemy_drops

# tags: Damaged Prism, Turbid Prism, Radiant Prism, обычные противники

# title_ru: Сломанная призма / Загрязнённая призма / Блестящая призма
# title_en: Prisms
# title_zh: 破缺棱晶 / 混浊棱晶 / 辉光棱晶
# region: Сумеру
# icon: assets/icons/items/common_enemies/damaged_prism.webp

# dropped_by: primal_construct_repulsor, primal_construct_reshaper, primal_construct_prospector

# material_1_id: damaged_prism
# material_1_ru: Сломанная призма
# material_1_en: Damaged Prism
# material_1_zh: 破缺棱晶
# material_1_icon: assets/icons/items/common_enemies/damaged_prism.webp

# material_2_id: turbid_prism
# material_2_ru: Загрязнённая призма
# material_2_en: Turbid Prism
# material_2_zh: 混浊棱晶
# material_2_icon: assets/icons/items/common_enemies/turbid_prism.webp

# material_3_id: radiant_prism
# material_3_ru: Блестящая призма
# material_3_en: Radiant Prism
# material_3_zh: 辉光棱晶
# material_3_icon: assets/icons/items/common_enemies/radiant_prism.webp
...
打倒元能构装体后获得的老旧零件。据说这些机械与同样来自沙海深处的「遗迹机关」不同，并不是作为歼灭与征服的使者被制造出来的。
