# id: sundjattas_first_foray
# category: books
# subtype: book_series
# icon: assets/icons/books/sundjattas_first_foray.webp
# title_ru: Первый поход Сундиаты
...
### Том 1
Тканый свиток, передаваемый из поколения в поколение среди Детей Эха. В нём рассказывается легенда о молодом Сундиате, жившем 500 лет назад.
...
Listen well to my name — Djeli Mamoudou of the Children of Echoes.
