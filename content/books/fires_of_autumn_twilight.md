# id: fires_of_autumn_twilight
# category: books
# subtype: book_series
# icon: assets/icons/books/fires_of_autumn_twilight.webp
# title_ru: Пламя осенних сумерек
...
### Том 1
Тканый свиток из клана Цветочного Пера. Похоже, он состоит из двух отдельных историй разных эпох, которые были объединены в некий момент времени.
